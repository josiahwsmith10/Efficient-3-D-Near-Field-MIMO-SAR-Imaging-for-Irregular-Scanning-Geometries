% PSF_EMPM - A demo of the Efficient Multiplanar Multistatic (EMPM)
% algorithm for the point spread function (PSF) with comparison against the
...
% Two points
target.tableTarget = [0,0.05,0.5,1];
...
%% Save All
THzToolboxSaveAll(wav,ant,scanner,target,im,"./results/PSF_EMPM.mat")

%% Load All
[wav,ant,scanner,target,im] = THzToolboxLoadAll("./results/PSF_EMPM.mat");
